...
const vec4 La = vec4(0.3, 0.3, 0.3, 1.0); // ambient
uniform vec4 kd = vec4(0.8);              // diffuse material
uniform vec4 Ld = vec4(1.0);              // diffuse light
uniform vec4 ks = vec4(0.5);              // specular material
uniform vec4 Ls = vec4(1.0);              // specular light
